...
export interface AssetManagerOptions {
  ...
  /**
   * Enable debug logging to diagnose path and scanning issues
   * Outputs root path, include patterns, and files found to console
   * @default false
   */
  debug?: boolean
  /**
   * Path aliases for resolving imports (e.g., @/ → app/)
   * Used by the importer scanner to detect which files import assets
   * @default { '@/': 'src/' }
   * @example { '@/': 'app/', '~/': '' } // For Nuxt 4
   */
